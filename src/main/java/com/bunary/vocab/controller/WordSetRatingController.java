...
public class WordSetRatingController {
        ...
        @GetMapping("{wordSetId}/ratings")
        public ResponseEntity<?> findAllByWordSetId(@PathVariable long wordSetId,
                ...
                Page<WordSetRatingResDTO> result = this.ratingService.findAllByWordSetId(wordSetId, pageable);
